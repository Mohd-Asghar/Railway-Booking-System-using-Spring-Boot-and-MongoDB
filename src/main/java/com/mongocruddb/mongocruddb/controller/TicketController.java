package com.mongocruddb.mongocruddb.controller;

import com.mongocruddb.mongocruddb.model.TicketModel;
import com.mongocruddb.mongocruddb.services.TicketService;
...
public class TicketController {
    ...
    public TicketModel updateTicket(@PathVariable("ticketId") @RequestBody int ticketId,@RequestBody TicketModel model){
